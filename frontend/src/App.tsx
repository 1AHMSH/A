...
function App() {
  ...
  const [CategoryList, setCategoryList] = useState([
    ...
    "Когда в последний раз обслуживалось",
    "Кем в последний раз обслуживалось",
  ]);
  ...
  const [Rows, setRows] = useState<Line[]>([
    {
      companySigDate: "150 кг",
      companySignatureName: "FK - 400",
      documentName: "Аппарат ИВЛ",
      documentStatus: "2 x 3 x 3",
      documentType: "Работает исправно",
      employeeNumber: "Пол года назад",
      employeeSigDate: "Полгода назад",
      employeeSignatureName: "Компания-изготовитель",
    },

    {
      companySigDate: "200 кг",
      companySignatureName: "FK - 100",
      documentName: "Аппарат ИВЛ",
      documentStatus: "2 x 3 x 6",
      documentType: "Работает исправно",
      employeeNumber: "Пол года назад",
      employeeSigDate: "Полгода назад",
      employeeSignatureName: "Компания-изготовитель",
  ...
  async function GetDataSet() {
    await fetch(`${process.env.REACT_APP_API_URL}/get`, {
      method: "GET",
      headers: {
